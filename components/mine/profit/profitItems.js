...
.profitItems thead tr th{background-color:var(--team-table-title-bg); color:var( --team-table-title-text); font-size:14px;padding:20px;font-weight:normal;}
...
.profitItems tbody tr td.empty{padding:5px !important;}
    `}</style>
            </section>
        )
    }
