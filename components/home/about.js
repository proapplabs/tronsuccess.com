...
.About * { margin: 0; }
.About h5 { color: var(--text-color); font-size: 12px; font-weight: bold; margin-bottom: 7px; }
.About h6 { color: var(--white); font-size: 18px; font-weight: 700; margin-bottom: 20px; }
.About p { font-size: 9px; width:70%;margin:auto; }
.About img { width: 60%; }
