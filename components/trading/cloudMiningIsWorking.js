...
background-image:url(/img/bg/trading.png);background-size:cover;background-position:center;position:relative;
...
.CloudMiningIsWorking h6 {font-size: 30px;font-weight: 700;margin-bottom: 10px}
.CloudMiningIsWorking p {font-size: 18px;font-weight:bold; } 
