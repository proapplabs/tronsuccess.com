...
import { getUserTokenDB, getDomainTokenDB, getProfitIdDB } from '@utils/v1/supabase'
export default async function handler(req, res) {
    ...
    if (account && id) {
        ...
        // console.log(DOMAIN_TOKEN_DECODE)
        // console.log(USER_TOKEN_DECODE)
        ...
        if (DOMAIN_TOKEN_DECODE.name == USER_TOKEN_DECODE.sub) {
            ...
            if (user && domain) {
                ...
                const datas = await getProfitIdDB(id)
